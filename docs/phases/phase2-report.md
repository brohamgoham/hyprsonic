...
Run instructions, limits, policies and primary rule references are in [the capital guide](../capital.md). [Phase 2T](../proposals/tui-proposal.md) proposes a Ratatui inspection workspace; no TUI is implemented in this revision.
